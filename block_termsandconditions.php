    ...
    public function get_content() {
        ...
        if($view || is_siteadmin()){
            if($termsandconditions = $DB->get_record('block_termsandconditions',array("userid"=>$USER->id,"courseid"=>$COURSE->id)) || is_siteadmin()){
                ...
                echo $this->page->context == CONTEXT_COURSE;
            }else{
                ...
                $content .= "<script>
                             $( document ).ready(function() {
                                var text = '<h1> TERMINOS Y CONDICIONES </h1>';
                                	...
                                	"text += ".'"'."<li align = 'justify'> Catálogo de Obras: Son todas aquellas obras que la Universidad mantiene en su Biblioteca, las cuales se pueden consultar en <a href='http://www.uai.cl/biblioteca'>http://www.uai.cl/biblioteca</a> </li></ol>".'";'.
